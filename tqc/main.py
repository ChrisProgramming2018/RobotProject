...
if __name__ == "__main__":
    ...
    parser.add_argument('--eval_freq', default=6e4, type=int)  # How often the evaluation step is performed (after how many timesteps)
    ...
    parser.add_argument('--policy_freq', default=1, type=int)         # Number of iterations to wait before the policy network (Actor model) is updated
    parser.add_argument('--repeat_opt', default=3, type=int)         # Number of iterations to wait before the policy network (Actor model) is updated
