...
if __name__ == "__main__":
    ...
    #parser.add_argument('--env-name', default="SawyerPickPlace", type=str, help='Name of a environment (set it to any Continous environment you want')
    #parser.add_argument('--env-name', default="BaxterPegInHole", type=str, help='Name of a environment (set it to any Continous environment you want')
    ...
    parser.add_argument('--max_timesteps', default=4e6, type=int)               # Total number of iterations/timesteps
    ...
    parser.add_argument('--lr_actor', default=3e-4, type=float)      # Exploration noise - STD value of exploration Gaussian noise
    parser.add_argument('--lr_critic', default=3e-4, type=float)      # Exploration noise - STD value of exploration Gaussian noise
    parser.add_argument('--lr_alpha', default=3e-4, type=float)      # Exploration noise - STD value of exploration Gaussian noise
    ...
    parser.add_argument('--policy_freq', default=4, type=int)         # Number of iterations to wait before the policy network (Actor model) is updated
    parser.add_argument('--repeat_opt', default=2, type=int)         # Number of iterations to wait before the policy network (Actor model) is updated
    parser.add_argument('--last', default=2e4, type=int)    # amount of qtarget nets
    ...
    parser.add_argument('--policy', default="TCQ", type=str)     # Maximum value of the Gaussian noise added to the actions (policy)
    ...
    parser.add_argument("--log_std_min_max", default=(-20, 2), type=tuple)
