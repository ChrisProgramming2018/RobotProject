...
class ReplayBuffer(object):
    ...
    def __init__(self, obs_shape, action_shape, capacity, image_pad, device, args):
    ...
    def sample_actor(self, batch_size):
        if self.idx < self.last:
            ...
            bottom = self.idx - self.last 
        idxs = np.random.randint(bottom, self.capacity if self.full else self.idx, size=batch_size)
    ...
    def sample(self, batch_size):
        ...
        for i in range(self.n_nets):
            ...
            obses_list.append(obses_aug)
            next_obses_list.append(next_obses_aug)

        return obses, actions, rewards, next_obses, not_dones_no_max, obses_list, next_obses_list
